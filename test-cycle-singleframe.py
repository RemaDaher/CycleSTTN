        ...
        with torch.no_grad():
            ...
            for i in range(len(neighbor_ids)):
                ...
                if comp_frames[idx] is None:
                    ...
                    #Rema:
    savebasepath=os.path.join(args.output,"gen_"+args.ckptnumber.zfill(5),"single_frame",video_name, overlaid, shifted, masking, whichmodel, Dil)
    ...
    if args.zip:
        ...
        for video_name in video_names:
            ...
            for i in range(len(frames)):
                ...
                evaluate(w, h, [frame], [fname], [mask], video_name, "A", model_A, device, overlaid, shifted, Dil, masking)
                evaluate(w, h, [frame], [fname], [mask], video_name, "B", model_B, device, overlaid, shifted, Dil, masking)
