...
#             frames = GroupRandomHorizontalFlip()(frames)  #Rema removed because not random masks anymore
        ...
        if self.masking=='empty' or self.masking=='loaded_add':
            NS_frames_tensors = self._to_tensors(NS_frames)*2.0 - 1.0
            return frame_tensors, NS_frames_tensors, mask_tensors
        else:
